def resumo_dolar(negociacoes, valor_intervalo, campo_ativo):
    if not negociacoes:
        return []
        ...
        if ativo == campo_ativo:
            ...
            if num_dia == num_dia_anterior:
                ...
                while valor_acumulado >= valor_intervalo:
                    ...
                    resumos.append((formatted_timestamp, preco_abertura, preco_maximo, preco_minimo, preco_fechamento, volume_a_registrar))
